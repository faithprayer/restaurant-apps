...
var searchContainer = /*#__PURE__*/function (_HTMLElement) {
  _inherits(searchContainer, _HTMLElement);
...
var API_ENDPOINT = {
  ...
  POST_REVIEW: "".concat(config/* default */.Z.BASE_URL, "review"),
  SEARCH: function SEARCH(value) {
    return "".concat(config/* default */.Z.BASE_URL, "search?q=").concat(value);
  }
};
...
var restaurantDbSource = /*#__PURE__*/function () {
  ...
  _createClass(restaurantDbSource, null, [{
    ...
    value: function () {
      var _searchRestaurant = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(value) {
        var response, responseJson;
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              _context3.next = 2;
              return fetch(api_endpoint.SEARCH(value));
            case 2:
    ...
    value: function () {
      var _postReviewRestaurant = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(newReview) {
        ...
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              ...
              _context4.next = 3;
              return fetch(api_endpoint.POST_REVIEW, option);
            case 3:
...
/* harmony import */ var _component_search_bar__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(401);
/* harmony import */ var _component_search_bar__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_component_search_bar__WEBPACK_IMPORTED_MODULE_3__);
